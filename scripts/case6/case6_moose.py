...
# Set file locations
case_name = "case6"
mesh_name = "mesh_square_QUAD8.msh"
...
disp_x_unordered = sim_data.node_vars['disp_x'][:, 1]
disp_y_unordered = sim_data.node_vars['disp_y'][:, 1]

sol_unordered = np.stack((disp_x_unordered, disp_y_unordered), axis=1)
